...
from src.model import gru_attention, lstm, transformer, seq2seq_attention
...
def create_seq2seq_attention(args, input_vocab_size, target_vocab_size):
    return gru_attention.GRU(input_vocab_size + 1, target_vocab_size + 1)
...
MODELS = {
    ...
    seq2seq_attention.NAME: create_seq2seq_attention,
}
