...
python custom_transformer_training.py --src data/splitted_data/valid/val_token10000.fr --src_vocab data/splitted_data/train/vocab10000.en --tgt_vocab data/splitted_data/train/vocab10000.fr translate
